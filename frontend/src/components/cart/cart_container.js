...
import { addToOrder, removeFromCart, getCart, removeCartItems, updateReward } from '../../actions/session_actions';
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        updateReward: (userData) => dispatch(updateReward(userData))
